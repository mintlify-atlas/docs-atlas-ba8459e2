...
<CardGroup cols={3}>
  <Card title="Tecnoempleo Spain 2026" icon="briefcase" href="data/sources">
  ...
  <Card title="Data Science Job Posts 2025" icon="globe" href="data/sources">
  ...
  <Card title="Stack Overflow Survey 2025" icon="chart-bar" href="data/sources">
...
<CardGroup cols={2}>
  <Card title="Most Demanded Skill" icon="code" href="results/technology-rankings">
  ...
  <Card title="Dominant Location" icon="location-dot" href="results/key-findings">
  ...
  <Card title="Top Job Family" icon="database" href="results/key-findings">
  ...
  <Card title="Salary Coverage" icon="euro-sign" href="results/salary-analysis">

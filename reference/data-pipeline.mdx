---
title: "End-to-End Data Pipeline for EDA Roles España"
...
<CardGroup cols={2}>
  ...
  <Card title="Salary data availability bias" icon="euro-sign">
    Does the ~30–40% salary disclosure rate correlate with specific roles, locations, or sources? Analysis identifies whether missingness is random or systematic.
  </Card>
</CardGroup>

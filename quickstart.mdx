---
title: "Quickstart: Run the EDA Pipeline Locally"
sidebarTitle: Quickstart
description: Get the project running on your machine in minutes — clone the repo, install dependencies, configure credentials, and execute all five notebooks in order.
---
...
<Steps>
  ...
  <Step title="Explore the Outputs">
    ...
    <CardGroup cols={2}>
      <Card title="Cleaned Datasets" icon="table">
      ...
      <Card title="Generated Charts" icon="image">
